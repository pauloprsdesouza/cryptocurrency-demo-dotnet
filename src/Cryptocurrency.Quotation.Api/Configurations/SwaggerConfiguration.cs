...
namespace Cryptocurrency.Quotation.Api.Configurations
{
    ...
    {
        private const string Title = "Cryptocurrency.Quotation API";
        private const string Description = "Cryptocurrency.Quotation API V1";
        ...
        public static void AddSwaggerDocumentation(this IServiceCollection services)
        {
            ...
            {
                string xmlComments = Path.Combine(AppContext.BaseDirectory, "Cryptocurrency.Quotation.Api.xml");
