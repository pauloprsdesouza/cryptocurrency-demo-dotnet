...
namespace Cryptocurrency.Quotation.Contracts.Cryptocurrencies
{
    public class CryptoInfoResponse
    {
        public Dictionary<string, List<CoinDataResponse>> Data { get; set; }
    ...
    {
        public UrlsResponse Urls { get; set; }
